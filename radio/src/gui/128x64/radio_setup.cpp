  ...
  for (uint8_t i=0; i<LCD_LINES-1; i++) {
    ...
    switch (k) {
      ...
      case ITEM_RADIO_SETUP_ROTARY_INVERSE:
        ...
        g_eeGeneral.rotEncDirection = editChoice(RADIO_SETUP_2ND_COLUMN, y, STR_INVERT_ROTARY, STR_INVERT_ROTARY_OPT, g_eeGeneral.rotEncDirection, 0, 2, attr, event);  // BOC1
        break;
#endif
